    ...
    async.waterfall([
        ...
        function waterfall4(mpuBucket, storedParts, jsonList, next) {
            const storedPartsAsObjects = storedParts.map(item => ({
                ...
                // BREAKING CHANGE -- NO LONGER SUPPORT PART DATA STRUCTURE
                // PRIOR TO VERSION 2.  VERSION 2 CREATED ON MAY 2, 2016
                // SO THIS CHANGE MEANS CANNOT COMPLETE AN MPU INITIATED
                // WITH FORMAT PRIOR TO THAT DATE.
